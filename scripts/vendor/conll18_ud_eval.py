...
#
# Modified 2019 by Marcel Bollmann <marcel@bollmann.me> to make functions
# return more data than just the scores.
#
# Changelog:
...
def make_alignment(gold_ud, system_ud):
    class AlignmentWord:
...
def evaluate(gold_ud, system_ud):
    ...
    alignment = make_alignment(gold_ud, system_ud)
